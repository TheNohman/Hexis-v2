...
function NumberField({
  ...
  return (
    <label className="flex flex-col gap-1">
      <span className="text-[10px] uppercase tracking-widest font-semibold text-muted">{label}</span>
      <input
        type="number"
        value={value}
        min={min}
        ...
        inputMode="numeric"
        className="rounded-xl border border-border bg-background px-3 py-2 text-sm outline-none focus:border-accent transition-colors tabular-nums"
      />
    </label>
  );
}
