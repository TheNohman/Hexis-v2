...
export function ConfirmDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm px-4"
      role="dialog" aria-modal="true" aria-labelledby="confirm-title" onClick={onCancel}>
      <div className="bg-background border border-border rounded-2xl p-6 max-w-sm w-full shadow-xl"
        ...
        <div className="flex gap-3 mt-6">
          <button ref={cancelRef} type="button" onClick={onCancel}
            className="flex-1 rounded-xl border border-border py-2.5 text-sm font-medium cursor-pointer hover:bg-surface-hover transition-colors">
            {cancelLabel}
          </button>
